...
//        afterSlide: function () {
  //          $("html, body").animate({scrollTop: 0}, 300);
    //    },
        //afterSlide: function () {$("#body").animate({scrollTop: 0}, 200)},
    ...
    function realResizeCatalog() {
        ...
        if (scrollPane.length) {
            columns.height(scrollPane.height() + delta);
        } else {
        ...
        if (cuttedPath[1] != "cart") {
            ...
            $(".menu-block-wrapper").height(columnsHeight);
        }
    }
...
//}
function addAll2Cart() {
    var notNew = $(".not_new_id");

    if (notNew.css("display") === "none") {
        notNew.show(300);
    } else {
        notNew.hide(300);
    }
